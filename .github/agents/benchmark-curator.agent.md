...
5. Run the catalog audit, rebuild `docs/catalog.md`, regenerate localized READMEs and `site/`, then run the unit tests and `awesome-lint` before proposing a change.
6. Keep generated `docs/catalog.md`, localized READMEs, and all `site/` exports synchronized with the source data.
